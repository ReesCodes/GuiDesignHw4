    ...
    $("#controlBox").validate({
        ...
        rules: {
            tableXmin: {
                ...
                max: function () { // must be <= tableXmax and  
                    return Math.min(parseFloat($("#tableXmax").val()) || 1000000);
                },
            },
            tableXmax: {
                required: true,
                ...
                min: function () {
                    return  Math.max(parseFloat($("#tableXmin").val()) || -1000000);
                },
                max: 1000000,
            ...
            tableYmin: {
                ...
                max: function () { // must be <= tableYmax 
                    return Math.min(parseFloat($("#tableYmax").val()) || 1000000);
                },
            },
            tableYmax: {
                required: true,
                ...
                min: function () {
                    return  Math.max(parseFloat($("#tableYmin").val()) || -1000000);
                },
                max: 1000000,
        ...
        messages: {
            tableXmin: {
                ...
                min: "Please enter a valid integer between -1000000 and 1000000.",
